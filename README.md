...
| | | |
|:-------------------------:|:-------------------------:|:-------------------------:|
|<img width="1500"  height="350" alt="Listings" src="https://github.com/Itskiprotich/BMI-Mobile/blob/master/screenshots/screen_1.png"> Patient Listing |  <img width="1500"  height="350" alt="Listing Search" src="https://github.com/Itskiprotich/BMI-Mobile/blob/master/screenshots/screen_2.png"> Listing Search |<img width="1500" height="350" alt="Vital Form" src="https://github.com/Itskiprotich/BMI-Mobile/blob/master/screenshots/screen_3.png"> Vital Form|
|<img  width="1604" alt="Login" src="https://github.com/Itskiprotich/Blogs-REST-API/blob/master/screenshots/create.png"> Create Post |  <img width="1604" alt="Login API" src="https://github.com/Keeprawteach/Blogs-REST-API/blob/master/screenshots/list.png"> List Posts |<img width="1604" alt="screen shot 2017-08-07 at 12 18 15 pm" src="https://github.com/Keeprawteach/Blogs-REST-API/blob/master/screenshots/detail.png"> Post Details|
